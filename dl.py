...
# def extract_archives(root_path, channel_name, p2a_desc, dl_desc, dl_dir, dl_filename, new_filename):
    ...
    for dir,subdir,listfilename in os.walk(root_path):
            ...
            for file in os.listdir(dir):
                ...
                #     shutil.move(os.path.join(root_path, dir, file), images_path)
                    ...
                    if root_path == dir:
                        os.makedirs(os.path.join(dir,os.path.splitext(file)[0]), exist_ok=True)
                        shutil.move(os.path.join(dir, file), os.path.join(dir,os.path.splitext(file)[0]))
    # if "."+ext in archive_ext_list:
    #     desc_path = os.path.join(dl_dir, new_filename, 'lbry_description.md')
    #     f = open(desc_path, "w+")
    #     f.write(
    #         dl_desc+
    #         p2a_desc
    ...
    #     f.close()
    # else :
    #     desc_path = os.path.join(dl_dir, dl_filename, 'lbry_description.md')
    #     f = open(desc_path, "w+")
    #     f.write(
    #         dl_desc+
    #         p2a_desc
...
#     p2a_desc = f'\n\nthis file was auto created by print2a.com custom lbry collector, it is the description taken from the downloaded upload on the lbry/odysee post @ https://odysee.com/{url_channel_name}:{url_channel_claim}/{dl_title} \n\n'
#     print("downloading...")
...
#     extract_archives(dl_dir,channel_name,p2a_desc,dl_desc,dl_dir,dl_filename,new_filename)
